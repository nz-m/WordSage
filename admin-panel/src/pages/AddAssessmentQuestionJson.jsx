...
const AddAssessmentQuestionJson = () => {
  ...
  const handleAddQuestions = async () => {
    try {
      ...
      await axios.post(
        `${BASE_URL}/level-assessment/add-questions`,
  ...
  const handleDeleteQuestions = async () => {
    try {
      ...
      await axios.delete(`${BASE_URL}/level-assessment/delete-questions`);
      setLoading(false);
      setError(null);
    ...
    <div>
      ...
      <div className="container mx-auto p-4">
        ...
        <button
          ...
          disabled={loading}
        >
          {loading ? "Deleting..." : "Delete Questions"}
        </button>
...
export default AddAssessmentQuestionJson;
